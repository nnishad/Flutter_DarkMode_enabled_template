      ...
      child: InkWell(
        onTap: () {
          if (widget.onTap != null) {
            ...
            if (appStore.isDarkModeOn &&
                !widget.data!.isDarkModeSupported.validate(value: true)) {
              appStore.toggleDarkMode(value: false);
            }
            if (widget.data!.themeType.validate() == ThemeTypeFullApp ||
                widget.data!.isContainsScaffold.validate()) {
          ...
          builder: (_) => Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    widget.icon != null
                        ...
                        : Image.asset(
                            abstractIconsList()[
                                widget.index % abstractIconsList().length],
                            height: 30),
                    Row(
                      children: [
                        Container(
                          child: Text(widget.data!.tag.validate().toUpperCase(),
                              style: boldTextStyle(
                                  size: 10,
                                  color: Colors.white,
                                  letterSpacing: 1.3)),
                          decoration: BoxDecoration(
                              color: Colors.green, borderRadius: radius(4)),
                          padding:
                ...
                (widget.child == null)
                    ? widget.child!
                    : Text(widget.data!.description.validate(),
