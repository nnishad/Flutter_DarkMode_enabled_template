...
import 'package:flutter_ui_draft/main/components/AppSettingsWidget.dart';
import 'package:flutter_ui_draft/main/utils/AppConstants.dart';
import 'package:flutter_ui_draft/main/utils/AppDataProvider.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Observer(
        builder: (_) => Scaffold(
          appBar: AppBar(
              title: Text(MainAppName, style: boldTextStyle(size: 24)),
              elevation: 0,
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text("App Settings", style: secondaryTextStyle(size: 16))
